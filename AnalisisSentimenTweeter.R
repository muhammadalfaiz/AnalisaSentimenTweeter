...
df<- read.csv("g:/Data/sentimen_uji.csv", stringsAsFactors = TRUE)
glimpse(df)

df$class <- as.factor(df$class)

custom_stopwords <- read.csv("g:/Data/stopword.csv", header = FALSE)
...
dr<- read.csv("g:/Data/sentimenfinalraduji.csv", stringsAsFactors = FALSE)
factor(dr$class)
